...
@Configuration //говорит о том, что класс - Java Configuration(проект на основе синтаксиса java, а не файла .xml)
               //активирует ApplicationContext

@EnableTransactionManagement //означает,что классы,помеченные @Transactional, должны быть обернуты аспектом транзакций.
@ComponentScan("com.space.service") //указывает, где искать компоненты проекта(пакет com.space.service)
 ...
 */
    ...
    public DataSource dataSource() {
        ...
        dataSource.setPassword("_iPassword678");
        return dataSource;
    }
